	...
	return (
		<div className="App">
				...
				<div className="row justify-content-md-center py-5 px-xl-5">
					<div className="col-md-6 col-12 py-5">
						<div className="text-center mb-2 pb-2">
							...
							<p>
								Amet lorem at rebum amet dolores. Elitr lorem
								dolor sed amet diam labore at justo ipsum eirmod
								duo labore labore.
							</p>
						</div>
						<form action="">
			...
			<a href="#" className="btn btn-primary back-to-top">
				I am hereeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
